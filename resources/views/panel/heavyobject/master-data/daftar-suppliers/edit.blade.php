...
<body>
    ...
    <main id="main" class="main d-flex justify-content-center align-items-center min-vh-100">
        <div class="col-md-6 col-lg-6">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title text-center">Edit Supplier</h5>

                    @yield('content')
                    <div class="container">
                        <form action="{{ route('daftar_suppliers.update', $supplier->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="no_telp" name="no_telp" value="{{ old('no_telp', $supplier->no_telp) }}">
                            </div>
                            <div class="form-group">
